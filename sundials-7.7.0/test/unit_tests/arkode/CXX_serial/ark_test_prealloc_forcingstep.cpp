 ...
 * based on test_logging_arkode_forcingstep.cpp by David J. Gardner @ LLNL
 * -----------------------------------------------------------------------------
 ...
 * -----------------------------------------------------------------------------
 * Test data preallocation in ForcingStep
 * ---------------------------------------------------------------------------*/
...
{
  cout << "Start ForcingStep preallocation test" << endl;
  ...
  void* arkode_mem = ForcingStepCreate(steppers[0], steppers[1], zero, y, sunctx);
  ...
  cout << "End ForcingStep preallocation test" << endl;

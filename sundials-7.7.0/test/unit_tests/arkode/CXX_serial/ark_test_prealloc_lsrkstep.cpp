 ...
 * based on test_logging_arkode_lsrkstep.cpp by David J. Gardner @ LLNL
 * -----------------------------------------------------------------------------
 ...
 * -----------------------------------------------------------------------------
 * Test data preallocation in LSRKStep
 * ---------------------------------------------------------------------------*/
...
{
  cout << "Start LSRKStep preallocation test" << endl;
  ...
  cout << "End LSRKStep preallocation test" << endl;

 ...
 * based on test_logging_arkode_erkstep.cpp by David J. Gardner @ LLNL
 * -----------------------------------------------------------------------------
 ...
 * -----------------------------------------------------------------------------
 * Test data preallocation in ERKStep
 * ---------------------------------------------------------------------------*/
...
{
  cout << "Start ERKStep preallocation test" << endl;
  ...
  cout << "End ERKStep preallocation test" << endl;

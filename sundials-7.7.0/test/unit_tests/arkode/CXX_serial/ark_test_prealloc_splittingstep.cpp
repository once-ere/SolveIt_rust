 ...
 * based on test_logging_arkode_splittingstep.cpp by David J. Gardner @ LLNL
 * -----------------------------------------------------------------------------
 ...
 * -----------------------------------------------------------------------------
 * Test data preallocation in SplittingStep
 * ---------------------------------------------------------------------------*/
...
{
  cout << "Start SplittingStep preallocation test" << endl;
  ...
  cout << "End SplittingStep preallocation test" << endl;

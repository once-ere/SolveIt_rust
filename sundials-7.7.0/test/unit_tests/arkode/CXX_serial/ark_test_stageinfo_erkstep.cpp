 ...
 * -----------------------------------------------------------------------------
 * Test stage information and pre/postprocessing routines in ERKStep
 * ---------------------------------------------------------------------------*/
...
{
  cout << "Start ERKStep StageInfo test" << endl;
  ...
  arkode_mem = ERKStepCreate(ode_rhs, zero, y, sunctx);
  ...
  cout << "End ERKStep StageInfo test" << endl;

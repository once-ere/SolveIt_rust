 ...
 * based on test_logging_arkode_arkstep.cpp by David J. Gardner @ LLNL
 * -----------------------------------------------------------------------------
 ...
 * -----------------------------------------------------------------------------
 * Test data preallocation in ARKStep
 * ---------------------------------------------------------------------------*/
...
{
  cout << "Start ARKStep preallocation test" << endl;
  ...
  cout << "End ARKStep preallocation test" << endl;

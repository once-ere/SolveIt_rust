...
\code{m1}, \code{m2}, \code{m\_rod} & number & RW & dumbbells only: the two sphere masses and the rod mass; writing rebuilds the body --- total mass, the COM offsets and the inertia tensor all follow (position and velocities are untouched)\\
...
\section{Fourteen worked examples}
